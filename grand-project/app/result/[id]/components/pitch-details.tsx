// /grand-project/app/result/[id]/components/pitch-details.tsx
...
// This is our new, dedicated Server Component for displaying the data.
export default async function PitchDetails({ id }: { id: string }) {
  // 1. It calls our data function to get all the data.
  const { pitchTitle, content } = await getPitch(id);

  // 2. It renders the full JSX.
  return (
